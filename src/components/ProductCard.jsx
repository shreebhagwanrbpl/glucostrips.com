            ...
            <div className="grid grid-cols-1 lg:grid-cols-[240px_1fr_180px] gap-5 lg:gap-8 items-center">
                ...
                <div className="flex justify-center lg:justify-end">
                    <Link
                        ...
                        className="bg-white rounded-[30px] border border-indigo-100 shadow-lg hover:shadow-[0_20px_45px_rgba(99,102,241,0.18)] hover:border-fuchsia-200 transition-all duration-300 p-8"
                    >
                        Get Quote
                    </Link>
                </div>
