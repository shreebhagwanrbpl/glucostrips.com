...
const ProductLink = memo(function ProductLink({ item, category, scrollToProduct }) {
  return (
    <button
      ...
      className="block w-full text-left py-1 text-sm text-slate-500 hover:text-indigo-600 hover:translate-x-1 transition-all duration-200 font-medium"
    >
      • {item.title}
    </button>
  );
  ...
  return (
    <div className="space-y-2 pl-2">
      ...
      <button
        ...
        className="w-full text-left py-1.5 flex justify-between items-center text-xs font-bold text-indigo-600 hover:text-fuchsia-600 transition-colors uppercase tracking-wider border-b border-slate-100 pb-1"
      >
      ...
      >
        <span className="flex items-center gap-3 text-sm font-semibold leading-none">
          <span className={`transition-transform duration-200 ${isOpened ? "rotate-90" : ""}`}>
            <ChevronRight size={16} className={isActive ? "text-indigo-600" : "text-slate-400 group-hover:text-indigo-600"} />
          </span>
          {category}
        </span>
        <span className={`text-xs font-semibold px-2 py-0.5 rounded-full ${isActive ? "bg-indigo-100 text-fuchsia-600" : "bg-slate-100 text-slate-500"
          }`}>
          {categoryProductCount}
        </span>
      </button>
  ...
  return (
    <Profiler id="ProductsLayout" onRender={onRenderCallback}>
      ...
      <section className="section-padding bg-white">
        ...
        <div className="max-w-2xl mx-auto mt-6 lg:mt-10 px-4 lg:px-0 relative">
          ...
          <input
            ...
            className="w-full h-16 pl-14 pr-5 rounded-2xl border border-slate-200 bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
          />
        </div>
            ...
            <div className="sticky top-0 -mx-6 pt-6 px-6 pb-3 bg-white z-20 border-b border-slate-100 mb-4 h-[116px]">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-10 pl-10 pr-4 rounded-xl border border-slate-200 bg-slate-50 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:bg-white transition-all"
                />
              </div>
            </div>
          ...
          <div className="space-y-16">
            {filteredProducts.length === 0 ? (
              <div className="bg-white border border-slate-200 rounded-[32px] p-10 lg:p-16 text-center shadow-lg">
                <div className="w-24 h-24 mx-auto rounded-full bg-indigo-100 flex items-center justify-center text-5xl mb-6">
                  🔍
                </div>
                ...
                <button
                  ...
                  className="mt-8 px-8 py-3 rounded-xl bg-gradient-to-r from-indigo-600 to-fuchsia-600 text-white font-semibold hover:shadow-[0_15px_35px_rgba(99,102,241,0.35)] transition"
                >
                  View All Products
                </button>
              </div>
        ...
        <div className="container-custom">
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8 mt-16">
            {[
              ...
              >
                <div className="w-16 h-16 mx-auto rounded-[22px] bg-indigo-100 text-indigo-600 flex items-center justify-center mb-6">
                  {item.icon}
                </div>
      ...
      {showTopButton && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 z-50 w-14 h-14 rounded-full bg-gradient-to-r from-indigo-600 to-fuchsia-600 text-white shadow-2xl hover:shadow-[0_15px_35px_rgba(99,102,241,0.35)] hover:scale-110 transition flex items-center justify-center"
        >
          <ChevronUp size={24} />
        </button>
      )}
