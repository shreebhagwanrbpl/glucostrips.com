      ...
      <section className="section-padding bg-white">
        ...
        <div className="max-w-2xl mx-auto mt-6 lg:mt-10 px-4 lg:px-0 relative">
          ...
          <input
            ...
            className="w-full h-16 pl-14 pr-5 rounded-2xl border border-slate-200 bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:border-indigo-600"
          />
        </div>
...
"
          ...
          <div className="space-y-16">
            {filteredProducts.length === 0 ? (
              ...
              <div className="bg-white border border-slate-200 rounded-[32px] p-10 lg:p-16 text-center shadow-lg">
                ...
                <div className="w-24 h-24 mx-auto rounded-full bg-indigo-50 border border-indigo-100/50 flex items-center justify-center text-5xl mb-6 shadow-inner">
                  🔍
                </div>
                ...
                <button
                  ...
                  className="mt-8 px-8 py-3 rounded-xl bg-gradient-to-r from-indigo-600 to-fuchsia-600 text-white font-semibold hover:opacity-90 transition shadow-md shadow-indigo-600/25 !text-white"
                >
                  View All Products
                </button>
                          ...
                          <div className="grid grid-cols-1 lg:grid-cols-[240px_1fr_180px] gap-5 lg:gap-8 items-center">
                            ...
                            <div className="flex justify-center lg:justify-end">
                              ...
                              <Link
                                ...
                                className="px-8 py-4 rounded-2xl bg-gradient-to-r from-indigo-600 to-fuchsia-600 hover:from-indigo-700 hover:to-fuchsia-700 !text-white font-semibold transition shadow-md shadow-indigo-600/10 text-center"
                              >
                                Get Quote
                              </Link>
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8 mt-16">
            ...
            {[
              ...
              >
                ...
                <div className="w-16 h-16 mx-auto rounded-[22px] bg-gradient-to-br from-indigo-50 to-indigo-100/40 border border-indigo-100/50 text-indigo-750 flex items-center justify-center mb-6 shadow-sm">
      ...
      {showTopButton && (
        ...
        <button
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 z-50 w-14 h-14 rounded-full bg-gradient-to-r from-indigo-600 to-fuchsia-600 text-white shadow-2xl shadow-indigo-600/30 hover:scale-110 transition flex items-center justify-center !text-white"
        >
