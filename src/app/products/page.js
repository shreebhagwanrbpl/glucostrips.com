...
export default function ProductsPage() {
  ...
  const products = [

    {
      ...
      description:
        "Roche-compatible electrolyte reagent intended for precise analyzer testing.",
      brand: "Roche",
      model: "9180",
  ...
  <div className="site1-static">
    <PageBanner
      title="Diagnostic & Medical Products"
    ...
    <section className="py-24 bg-slate-50">
      ...
      <div className="max-w-7xl mx-auto px-5">
        ...
        <SectionTitle
          ...
          description="Find diagnostic products appropriate for hospital laboratories and independent testing facilities."
          center
        />
        ...
        <div className="grid lg:grid-cols-[320px_1fr] gap-10 mt-16">
          ...
          <aside className="sticky top-28 h-fit bg-white rounded-3xl border border-slate-200 shadow-xl p-6">
            ...
            <input
              ...
              className="w-full h-12 mt-5 rounded-xl border border-slate-300 px-4 outline-none focus:border-indigo-600 focus:ring-1 focus:ring-indigo-600"
            />
                          ...
                          <div className="grid lg:grid-cols-[250px_1fr_180px] gap-8 items-center">
                            ...
                            <div className="flex justify-center lg:justify-end">
                              ...
                              >
                                ...
                                <button className="bg-gradient-to-r from-indigo-600 to-fuchsia-600 hover:from-indigo-700 hover:to-fuchsia-700 text-white font-semibold px-8 py-4 rounded-xl transition w-full shadow-md shadow-indigo-600/10 !text-white">
                                  View Details
                                </button>
      ...
      <section className="py-24 bg-white">
        ...
        <div className="max-w-7xl mx-auto px-5">
          ...
          <SectionTitle
            badge="Why Choose Our Product Range"
            title="Trusted Quality & Innovation"
            description="We prioritize products aligned with recognized quality requirements and backed by practical customer support."
            center
          />
            ...
            {[
              {
                ...
                desc: "Equipment and supplies are selected with close attention to quality and performance requirements.",
              },

              {
                icon: <Truck size={32} />,
                title: "Fast Delivery",
                desc: "We coordinate nationwide shipment with careful handling and suitable protective packaging.",
              },

              {
                icon: <BadgeCheck size={32} />,
                title: "Trusted Support",
                desc: "Our team provides product, quotation, and service assistance when customers need it.",
              },

              {
                icon: <PackageCheck size={32} />,
                title: "Premium Equipment",
                desc: "High-capability biomedical equipment suited to professional laboratory applications.",
              },
              ...
              >
                ...
                <div className="w-20 h-20 mx-auto rounded-3xl bg-gradient-to-br from-indigo-50 to-indigo-100/50 border border-indigo-100/50 flex items-center justify-center text-indigo-600 mb-6 shadow-sm">
                  {item.icon}
                </div>
